...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 191488 kB; (`sectionID`) REFER `fkdb-system/sec';
...
INSERT INTO `simple_users` (`userID`, `username`, `password`, `firstname`, `lastname`, `email`, `admin`, `enabled`, `added`, `lastlogin`, `language`, `preferedDesign`) VALUES
	(1, 'admin', '*4ACFE3202A5FF5CF467898FC58AAB1D615029441', 'Admin', 'Adminsson', 'admin@admin.com', 1, 1, '2014-10-15 21:27:00', '2015-07-07 18:25:55', NULL, NULL);
