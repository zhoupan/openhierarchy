...
-- Dumping structure for table openhierarchy-system.goal
...
-- Dumping data for table openhierarchy-system.goal: ~1 rows (approximately)
DELETE FROM `goal`;
/*!40000 ALTER TABLE `goal` DISABLE KEYS */;
INSERT INTO `goal` (`id`, `minutes`, `type`) VALUES
	(1, 10, '3km');
...
INSERT INTO `openhierarchy_data_sources` (`dataSourceID`, `url`, `type`, `enabled`, `driver`, `username`, `password`, `name`, `logAbandoned`, `removeAbandoned`, `removeTimeout`, `testOnBorrow`, `validationQuery`, `maxActive`, `maxIdle`, `minIdle`, `maxWait`, `defaultCatalog`) VALUES
	(1, 'jdbc:mysql://127.0.0.1:3306/openhierarchy-system', 'SystemManaged', 1, 'com.mysql.jdbc.Driver', 'root', '123456', 'SystemDatabase', 1, 1, 30, 1, 'SELECT 1', 100, 30, 0, 10000, NULL);
...
-- Dumping data for table openhierarchy-system.openhierarchy_foreground_modules: ~21 rows (approximately)
...
INSERT INTO `openhierarchy_foreground_modules` (`moduleID`, `classname`, `name`, `alias`, `description`, `xslPath`, `xslPathType`, `anonymousAccess`, `userAccess`, `adminAccess`, `enabled`, `visibleInMenu`, `sectionID`, `dataSourceID`, `staticContentPackage`, `requiredProtocol`) VALUES
	(1, 'se.unlogic.hierarchy.foregroundmodules.login.UserProviderLoginModule', 'Logga in', 'login', 'Modul f�r inloggning', 'LoginModule.sv.xsl', 'Classpath', 1, 0, 0, 1, 1, 1, 1, NULL, NULL),
	(2, 'se.unlogic.hierarchy.foregroundmodules.logout.LogoutModule', 'Logga ut', 'logout', 'Modul f�r utloggning', 'LogoutModule.sv.xsl', 'Classpath', 0, 1, 1, 1, 0, 1, NULL, NULL, NULL),
	(3, 'se.unlogic.hierarchy.foregroundmodules.useradmin.UserAdminModule', 'Anv�ndare', 'useradmin', 'Modul f�r anv�ndaradministration', 'UserAdminModule.sv.xsl', 'Classpath', 0, 0, 1, 1, 1, 2, 1, 'staticcontent', NULL),
	(4, 'se.unlogic.hierarchy.foregroundmodules.userprofile.UserProfileModule', 'Mina inst�llningar', 'userprofile', 'Modul f�r �ndring av anv�ndaruppgifter', 'UserProfileModule.sv.xsl', 'Classpath', 0, 1, 1, 1, 1, 2, 1, NULL, NULL),
	(5, 'se.unlogic.hierarchy.foregroundmodules.datasourceadmin.DataSourceAdminModule', 'Datak�llor', 'datasources', 'Administration av datak�llor', 'DataSourceAdminModule.en.xsl', 'Classpath', 0, 0, 1, 1, 1, 2, NULL, 'staticcontent', NULL),
	(6, 'se.unlogic.hierarchy.foregroundmodules.systemadmin.SystemAdminModule', 'Moduler och Sektioner', 'systemadmin', 'Modul f�r administration av systemets olika moduler och sektioner', 'SystemAdminModule.sv.xsl', 'Classpath', 0, 0, 1, 1, 1, 2, NULL, 'staticcontent', NULL),
	(7, 'se.unlogic.hierarchy.foregroundmodules.pagemodules.PageViewModule', 'Sidvisningsmodul', 'page', 'Modul f�r visning av statiska sidor', 'PageViewModule.sv.xsl', 'Classpath', 1, 1, 1, 1, 1, 2, NULL, NULL, NULL),
	(8, 'se.unlogic.hierarchy.foregroundmodules.menuadmin.MenuAdminModule', 'Meny', 'menuadmin', 'Modul f�r menyadministration', 'MenuAdminModule.sv.xsl', 'Classpath', 0, 0, 1, 1, 1, 2, NULL, 'staticcontent', NULL),
	(9, 'se.unlogic.hierarchy.foregroundmodules.pagemodules.PageAdminModule', 'Sidor', 'pageadmin', 'Modul f�r administration av statiska sidor', 'PageAdminModule.sv.xsl', 'Classpath', 0, 0, 1, 1, 1, 2, NULL, 'staticcontentadmin', NULL),
	...
	(12, 'se.unlogic.hierarchy.foregroundmodules.threadinfo.ThreadInfoModule', 'Tr�dinfo', 'threadinfo', 'Tr�dinfo', 'ThreadInfoModule.en.xsl', 'Classpath', 0, 0, 1, 1, 1, 2, NULL, 'staticcontent', NULL),
	(13, 'se.unlogic.hierarchy.foregroundmodules.staticcontent.StaticContentModule', 'Modul f�r statiska filer', 'static', 'Modul f�r statiska filer', NULL, NULL, 1, 1, 1, 1, 0, 1, NULL, NULL, NULL),
	...
	(15, 'se.unlogic.hierarchy.foregroundmodules.groupadmin.GroupAdminModule', 'Grupper', 'groups', 'Modul f�r administration av grupper', 'GroupAdminModule.sv.xsl', 'Classpath', 0, 0, 1, 1, 1, 2, 1, 'staticcontent', NULL),
	(16, 'se.unlogic.hierarchy.foregroundmodules.usersessionadmin.UserSessionAdminModule', 'Inloggade anv�ndare', 'sessions', 'Visar samtliga inloggade anv�ndare', 'UserSessionAdminModule.xsl', 'Classpath', 0, 0, 1, 1, 1, 2, NULL, 'staticcontent', NULL),
	(17, 'se.unlogic.hierarchy.foregroundmodules.issuetracker.PrivilegeAdminModule', 'Administrera r�ttigheter i �rendehanteringen', 'privilegeadminmodule', 'Administrera r�ttigheter i �rendehanteringen', 'PrivilegeAdminModule.xsl', 'Classpath', 0, 0, 1, 0, 1, 2, 1, 'staticcontent', NULL),
	(18, 'se.unlogic.hierarchy.foregroundmodules.mailsenders.persisting.PersistingMailSender', 'E-post k�', 'mailsender', 'Modul f�r utskick av e-post', NULL, NULL, 0, 0, 1, 0, 1, 2, NULL, NULL, NULL),
	...
	(21, 'com.projecttemplate.modules.example.ExampleModule', 'Example page', 'index', 'Example page...', 'ExampleModuleTemplate.xsl', 'Classpath', 0, 1, 0, 1, 1, 2, NULL, 'staticcontent', NULL);
...
-- Dumping data for table openhierarchy-system.openhierarchy_foreground_module_settings: ~38 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=503 DEFAULT CHARSET=utf8 COMMENT='InnoDB free: 206848 kB; (`sectionID`) REFER `foraldramotet-o';

-- Dumping data for table openhierarchy-system.openhierarchy_menu_index: ~47 rows (approximately)
...
INSERT INTO `openhierarchy_sections` (`sectionID`, `parentSectionID`, `alias`, `enabled`, `anonymousAccess`, `userAccess`, `adminAccess`, `visibleInMenu`, `breadCrumb`, `name`, `description`, `anonymousDefaultURI`, `userDefaultURI`, `requiredProtocol`) VALUES
	(1, NULL, 'firstpage', 1, 1, 1, 1, 1, 1, 'F�rstasidan', 'F�rstasidan...', '/login', '/index', NULL),
...
INSERT INTO `openhierarchy_virtual_menu_items` (`menuItemID`, `itemtype`, `name`, `description`, `url`, `anonymousAccess`, `userAccess`, `adminAccess`, `sectionID`) VALUES
	...
	(55, 'TITLE', 'F�rstasidan', 'F�rstasidan', NULL, 0, 1, 1, 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='InnoDB free: 191488 kB; (`sectionID`) REFER `fkdb-system/sec';
...
INSERT INTO `simple_users` (`userID`, `username`, `password`, `firstname`, `lastname`, `email`, `admin`, `enabled`, `added`, `lastlogin`, `language`, `preferedDesign`) VALUES
	(1, 'admin', '*4ACFE3202A5FF5CF467898FC58AAB1D615029441', 'Admin', 'Adminsson', 'admin@admin.com', 1, 1, '2014-10-15 21:27:00', '2016-12-22 14:27:22', NULL, NULL);
